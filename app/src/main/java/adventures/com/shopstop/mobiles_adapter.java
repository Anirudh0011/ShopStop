...
public class mobiles_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Activity activity;
    ArrayList<recycler_model> recycler_modelArrayList;
    mobiles fragment;
    Context context;

    public mobiles_adapter(Activity activity, ArrayList<recycler_model> recycler_modelArrayList, mobiles fragment, Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        show=new mobiles_adapter.recyclerMain(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final mobiles_adapter.recyclerMain holder=(mobiles_adapter.recyclerMain) viewHolder;
