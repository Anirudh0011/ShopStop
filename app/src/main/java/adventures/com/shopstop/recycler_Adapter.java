...
public class recycler_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Context context;
        ...
        public recycler_Adapter(Activity activity, ArrayList<recycler_model> recycler_modelArrayList, cmaera fragment, Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        show=new recycler_Adapter.recyclerMain(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
            ...
            final recycler_Adapter.recyclerMain holder=(recycler_Adapter.recyclerMain) viewHolder;
