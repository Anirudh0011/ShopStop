...
public class recycler_Adapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        Activity activity;
        ArrayList<recycler_model> recycler_modelArrayList;

        public recycler_Adapter1(Activity activity, ArrayList<recycler_model> recycler_modelArrayList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        show=new recycler_Adapter1.recyclerMain(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
            ...
            final recycler_Adapter1.recyclerMain holder=(recycler_Adapter1.recyclerMain) viewHolder;
        ...
        holder.tosingleLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // editor.putString("imagePreferance", encodeTobase64(holder.grid_img));
                ...
                Intent i =new Intent(activity, single_product.class);
