...
public class laptops_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Activity activity;
    ArrayList<recycler_model> recycler_modelArrayList;
    laptops fragment;
    Context context;

    public laptops_adapter(Activity activity, ArrayList<recycler_model> recycler_modelArrayList, laptops fragment, Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        show=new laptops_adapter.recyclerMain(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final laptops_adapter.recyclerMain holder=(laptops_adapter.recyclerMain) viewHolder;
