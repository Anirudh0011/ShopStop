...
public class recycler_Adapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public recycler_Adapter2(Activity activity, ArrayList<recycler_model> recycler_modelArrayList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        show=new recycler_Adapter2.recyclerMain(view);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        final recycler_Adapter2.recyclerMain holder=(recycler_Adapter2.recyclerMain) viewHolder;
